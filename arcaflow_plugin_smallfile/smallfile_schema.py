...
class SmallfileParams:
    ...
    stonewall: typing.Optional[YesNo] = field(
        ...
        metadata={
            "name": "Stonewall",
            "description": (
                "Measure thread throughput when another thread has finished"
            ),
        },
    )
    finish: typing.Optional[YesNo] = field(
        ...
        metadata={
            ...
            "description": (
                "Complete all file operations even if measurement has finished"
            ),
        },
    )
...
class SmallfileOutputParams:
    """
    smallfile echos its test parameters back in the output, but with some
    different formats. We'll keep these for indexing consistency.
    """
    ...
    host_set: str = field(
        metadata={
            "name": "Host set",
            "description": (
                "Always 'localhost' because we don't use smallfile's"
                " multi-host features"
            ),
        }
    )
...
class SmallfileOutputResults:
    """
    This the complete results structure, inclusive of the list of thread
    structures.
    """
