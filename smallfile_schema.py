...
class SmallfileParams:
    ...
    files: typing.Optional[int] = field(
        default=None,
        metadata={
            "name": "File count",
    ...
    auto_pause: typing.Optional[YesNo] = field(
        default=None,
        metadata={
            "id": "auto-pause",
            "name": "Auto pause",
    ...
    fsync: typing.Optional[YesNo] = field(
        default=None,
        metadata={
            "name": "fsync",
    ...
    files_per_dir: typing.Optional[int] = field(
        default=None,
        metadata={
            "id": "files-per-dir",
    ...
    dirs_per_dir: typing.Optional[int] = field(
        default=None,
        metadata={
            "id": "dirs-per-dir",
    ...
    record_size: typing.Optional[int] = field(
        default=None,
        metadata={
            "id": "record-size",
            "name": "Record size (KB)",
            "description": ("Size in KB of data transferred "
    ...
    xattr_size: typing.Optional[int] = field(
        ...
        metadata={
            "id": "xattr-size",
            "name": "xattr size (B)",
            "description": ("Size in bytes of extended attribute "
                            "value in bytes"),
        },
    )
    ...
    stonewall: typing.Optional[YesNo] = field(
        default=None,
        metadata={
            "name": "Stonewall",
            "description": ("Measure thread throughput when "
                            "another thread has finished"),
        },
    )
    finish: typing.Optional[YesNo] = field(
        default=None,
        metadata={
            "name": "Finish operations",
            "description": ("Complete all file operations even "
                            "if measurement has finished"),
        },
    )
    prefix: typing.Optional[str] = field(
        default=None,
        metadata={"name": "File prefix", "description": "Filename prefix"},
    )
    suffix: typing.Optional[str] = field(
        default=None,
        metadata={"name": "File suffix", "description": "Filename suffix"},
    )
    hash_into_dirs: typing.Optional[YesNo] = field(
        default=None,
        metadata={
            "id": "hash-into-dirs",
            "name": "Hash into directories",
            "description": ("Assign next file to a directory "
    ...
    verify_read: typing.Optional[YesNo] = field(
        default=None,
        metadata={
            "id": "verify-read",
            "name": "Verify read",
    ...
    incompressible: typing.Optional[YesNo] = field(
        default=None,
        metadata={
            "name": "Incompressible files",
            "description": ("Generate pure-random files that "
...
class WorkloadParams:
    """
    This is the data structure for the input
    parameters of the step defined below.
    """

    smallfile_params: SmallfileParams
    cleanup: typing.Optional[bool] = field(
        default=True,
        metadata={
            "name": "Cleanup files",
            "description": ("Whether to cleanup files "
                            "and directories after a run"),
        },
    )
...
class SmallfileOutputParams:
    """
    smallfile echos its test parameters back
    in the output, but with some different formats.
    ...
    host_set: str = field(
        metadata={
            "name": "Host set",
            "description": ("Always 'localhost' because we don't "
                            "use smallfile's multi-host features"),
        }
    )
    launch_by_daemon: bool = field(
        metadata={
            "name": "Launch by daemon",
            "description": ("Always 'false' because we don't use "
                            "smallfile's daemon feature"),
        }
    )
    version: str = field(
        metadata={"name": "Version", "description": "Smallfile version"}
    )
    top: str = field(
        metadata={
            "name": "Top directory",
    ...
    cleanup_delay_usec_per_file: int = field(
        metadata={
            "name": "Cleanup delay (usec)",
            "description": "Delay in usec after cleanup operation",
        }
    )
    finish_all_requests: YesNo = field(
        metadata={
            "name": "Finish operations",
            "description": ("Complete all file operations even "
                            "if measurement has finished"),
    ...
    xattr_size: int = field(
        metadata={
            "name": "xattr size (B)",
            "description": ("Size in bytes of extended "
                            "attribute value in bytes"),
        }
    )
    ...
    host_timeout: int = field(
        metadata={
            "name": "Host timeout",
            "description": "Always '3' as unsupported feature",
        }
    )
    fname_prefix: typing.Optional[str] = field(
        default=None,
        metadata={"name": "File prefix", "description": "Filename prefix"},
    )
    fname_suffix: typing.Optional[str] = field(
        default=None,
        metadata={"name": "File suffix", "description": "Filename suffix"},
    )
...
class SmallfileOutputResults:
    """
    This the complete results structure,
    inclusive of the list of thread structures.
    """
    ...
    IOPS: float = field(
        metadata={"name": "Total IOPS", "description": "IOPS rate for the job"}
    )
    MiBps: float = field(
        metadata={
            "name": "Total MiBps",
    ...
    totalhreads: int = field(
        metadata={
            "name": "Total threads",
            "description": "Total number of threads",
        }
    )
    totalDataGB: float = field(
        metadata={"name": "Total Data (GB)", "description": "Total data in GB"}
    )
    pctFilesDone: float = field(
        metadata={
...
class SmallfileOutputRsptimes:
    ...
    samples: int = field(
        metadata={"name": "Samples", "description": "Number of file samples"}
    )
    min: float = field(
        metadata={"name": "Minimum", "description": "Minimum response time"}
    )
    max: float = field(
